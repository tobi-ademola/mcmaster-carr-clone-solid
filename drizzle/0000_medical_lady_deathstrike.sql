...
CREATE TABLE IF NOT EXISTS "subcollections" (
	"slug" serial PRIMARY KEY NOT NULL,
	"name" text NOT NULL,
	"image_url" text,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "subcategories" ADD CONSTRAINT "subcategories_subcollection_id_subcollections_slug_fk" FOREIGN KEY ("subcollection_id") REFERENCES "public"."subcollections"("slug") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "subcollections" ADD CONSTRAINT "subcollections_categories_slug_categories_slug_fk" FOREIGN KEY ("categories_slug") REFERENCES "public"."categories"("slug") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "subcollections_category_slug_idx" ON "subcollections" USING btree ("categories_slug");