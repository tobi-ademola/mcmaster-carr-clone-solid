...
export const Category = typeof categories.$inferSelect;

export const subcollections = pgTable(
  "subcollections",
  {
    id: serial("slug").primaryKey(),
    name: text("name").notNull(),
    image_url: text("image_url"),
    category_slug: text("categories_slug")
      .notNull()
...
export type Subcollections = typeof subcollections.$inferSelect;
...
export type SubCategory = typeof subcategories.$inferInsert;
